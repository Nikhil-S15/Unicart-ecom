...
router
  ...
  .get(auth.adminAuth, adminController.handleEditCategorys)
  .patch(adminController.handleEditCategoryPatch);
...
router
  ...
  .delete(adminController.removeSubCategory);
...
router
  .route("/order-list/:id")
  .get(auth.adminAuth, adminController.getOrderList);

// get Order Details Page.
router
  .route("/order-details")
  .get(auth.adminAuth, adminController.getOrderDetails);
...
router
  ...
  .get(auth.adminAuth, couponController.generatorCouponCode);
