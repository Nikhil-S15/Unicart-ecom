...
module.exports = {
  ...
  postaddCoupon: (data) => {
    try {
      return new Promise((resolve, reject) => {
        couponModel.Coupon.findOne({ couponCode: data.couponCode }).then(
          (coupon) => {
            if (coupon) {
  ...
  applyCoupon: (couponCode, total) => {
    try {
      return new Promise((resolve, reject) => {
        couponModel.Coupon.findOne({ couponCode: couponCode }).then(
          (couponExist) => {
            if (couponExist) {
  ...
  verifyCoupon: (userId, couponCode) => {
    try {
      return new Promise((resolve, reject) => {
        couponModel.Coupon.find({ couponCode: couponCode }).then(
          async (couponExist) => {
            if (couponExist) {
